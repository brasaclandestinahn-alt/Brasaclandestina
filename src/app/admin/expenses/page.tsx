      ...
      <div className="admin-layout">
        ...
        <main className="main-content-responsive">
          <header style={{ marginBottom: "2rem" }}>
            <h1 style={{ fontSize: "clamp(1.5rem, 5vw, 2rem)", fontWeight: 700 }}>Gestión de Gastos y Facturas</h1>
            <p style={{ color: "var(--text-muted)", marginTop: "0.5rem", fontSize: "0.9rem" }}>Registra y controla el flujo de salida de efectivo por compras de insumos y otros costos operativos.</p>
          </header>
