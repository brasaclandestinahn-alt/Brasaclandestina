...
export default async function ProductPage({ params }: Props) {
  ...
  return (
    <div style={{ backgroundColor: 'var(--bg-dark)', minHeight: '100vh', color: 'var(--text-cream)' }}>
      ...
      <main style={{ padding: '4rem 1.5rem', maxWidth: '1000px', margin: '0 auto' }}>
        <div style={{ 
          ...
          <div>
            ...
            <h1 className="serif" style={{ fontSize: '3.5rem', margin: '0.5rem 0' }}>{product.name}</h1>
            <p style={{ 
                fontSize: '1.1rem', 
            ...
            <a 
              ...
              style={{ padding: '1.25rem 2.5rem', fontSize: '1.1rem', width: '100%', textAlign: 'center' }}
            >
      ...
      <section style={{ padding: '4rem 1.5rem', backgroundColor: 'rgba(255,255,255,0.02)' }}>
          <div style={{ maxWidth: '1000px', margin: '0 auto' }}>
              <h2 className="serif" style={{ fontSize: '2rem', marginBottom: '2rem' }}>También te podría gustar</h2>
              {/* Aquí iría un grid de productos similares */}
          </div>
      </section>
    </div>
  );
